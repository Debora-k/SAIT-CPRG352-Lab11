...
('kdbr0104+admin@gmail.com', true, 'Admin','Admin', 'password', 1),
('kdbr0104+anne@gmail.com', true, 'Anne','Annerson', 'password', 2),
('kdbr0104+barb@gmail.com', true, 'Barb','Barber', 'password', 2);

INSERT INTO `note` (`Title`, `Contents`, `Owner`) VALUES
('Quote #1', 'Writing is nature''s way of letting you know how sloppy your thinking is.', 'kdbr0104+anne@gmail.com'),
('Another quote', '"Java is to JavaScript as ham is to hamster." -  Jeremy Keith', 'kdbr0104+anne@gmail.com'),
('Barb''s Note', 'Anne should not see this note.', 'kdbr0104+barb@gmail.com');
